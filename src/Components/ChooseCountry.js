    ...
    return(
        <div className='container'>
            ...
            <div className='select-country'>
                <button className='btn btn-primary' onClick={changeCountry}>Uzbekistan</button>
                <button className='btn btn-warning' onClick={changeCountry}>USA</button>
                <button className='btn btn-success' onClick={changeCountry}>Poland</button>
            </div>
            <hr />
            <p>{country}</p>
        </div>
